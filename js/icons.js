...
(function (global) {
  const PATHS = {
    ...
    'eye-off':
      '<path d="M9.9 5.8A9.8 9.8 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a16.7 16.7 0 0 1-3.4 4.1"/>' +
      '<path d="M6.3 7.8A16.7 16.7 0 0 0 2.5 12S6 18.5 12 18.5a9.7 9.7 0 0 0 3.7-.7"/>' +
